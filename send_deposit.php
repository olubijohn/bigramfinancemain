...
if (isset($_SESSION['id'])) {
  ...
  if (isset($_POST['proceed'])) {
      ...
      $amount = $_POST['amount'];
      $type = $_POST['type'];
      if($plan == 0 || empty($amount)) {
        header("Location: ./deposit.php?error=empty");
      } elseif ($plan == 7 && $amount < 2000) {
        header("Location: ./deposit.php?error=price");
      } elseif ($plan == 10 && $amount < 1000) {
        header("Location: ./deposit.php?error=price");
      } elseif ($plan == 12 && $amount < 5000) {
        header("Location: ./deposit.php?error=price");
      }
  } else {
              ...
              <div class="col-md-6 offset-md-3 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div
                      class="widget-content widget-content-area clipboard-copy-input"
                    >
                      <p class="">
                        Choose a preferred payment option <code></code>
                      </p>
                      <div class="clipboard">
                        <form class="form-horizontal">
                          ...
                          <a
                            ...
                            data-clipboard-target="#btc"
                            onclick="copy_ref('btc', '#btc-btn')"
                          >
                            <svg
...
"
                          ...
                          <a
                            ...
                            data-clipboard-action="copy"
                            id="usdt-btn"
                            data-clipboard-target="#usdt"
                            onclick="copy_ref('usdt', '#usdt-btn')"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                      ...
                      <div class="clipboard">
                        <form class="form-horizontal">
                          ...
                          <a
                            ...
                            href="javascript:;"
                            data-clipboard-action="copy"
                            data-clipboard-target="#doge"
                            id="doge-btn"
                            onclick="copy_ref('doge', '#doge-btn')"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                      ...
                      <div class="clipboard">
                        <form class="form-horizontal">
                          ...
                          <a
                            ...
                            href="javascript:;"
                            data-clipboard-action="copy"
                            data-clipboard-target="#shib"
                            id="shib-btn"
                            onclick="copy_ref('shib', '#shib-btn')"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                      ...
                      <div class="clipboard">
                        <form class="form-horizontal" action="./includes/deposit.inc.php" method="post">
                          ...
                          <a
                            ...
                            href="javascript:;"
                            data-clipboard-action="copy"
                            data-clipboard-target="#lite"
                            id="lite-btn"
                            onclick="copy_ref('lite', '#lite-btn')"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                      ...
                      <!-- <div class="clipboard">
                        <form class="form-horizontal">
                          <input
                            ...
                            class="form-control mb-1"
                            id="shib"
                            value="ltc1qz8zwdn2c2qxn4dv2ngdsf7yvqf33yrf9vrctz0"
                          />
                          <a
                            class="mb-4 btn btn-primary"
                            href="javascript:;"
